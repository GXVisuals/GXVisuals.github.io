...
const Portfolio = () => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      gallery: [
        { src: portfolio69, alt: "Hills Panorama Villa 1 - Infinity Pool and L-Shaped Elevation View", type: "exterior", room: "pool deck" },
        { src: portfolio70, alt: "Hills Panorama Villa 1 - Poolside Deck View and Modern Facade", type: "exterior", room: "pool deck" },
        { src: portfolio71, alt: "Hills Panorama Villa 1 - Minimalist White and Stone Exterior Sideway", type: "exterior", room: "facade" },
        { src: portfolio72, alt: "Hills Panorama Villa 1 - High-Angle View of Villa and Infinity Pool", type: "exterior", room: "pool deck" },
        { src: portfolio73, alt: "Hills Panorama Villa 1 - Side Angle View Facing Coastline and Pool", type: "exterior", room: "pool deck" },
        { src: portfolio74, alt: "Hills Panorama Villa 1 - Broad Overview of Villa and Landscaped Grounds", type: "exterior", room: "pool deck" },
        { src: portfolio75, alt: "Hills Panorama Villa 1 - Sleek Kitchen with Minimalist Island Counter", type: "interior", room: "kitchen" },
        { src: portfolio76, alt: "Hills Panorama Villa 1 - Open-Plan Dining and Living Space with Sea Views", type: "interior", room: "living room" },
        { src: portfolio77, alt: "Hills Panorama Villa 1 - Formal Dining Table and Accent Round Mirror", type: "interior", room: "living room" },
        { src: portfolio78, alt: "Hills Panorama Villa 1 - Modern Bar Counter and Seamless Indoor-Outdoor Transition", type: "interior", room: "kitchen" },
        { src: portfolio79, alt: "Hills Panorama Villa 1 - Modern Bar Counter and Seamless Indoor-Outdoor Transition", type: "interior", room: "kitchen" },
      ],
    },
    {
      id: 16,
